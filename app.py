...
MODEL_PATH = os.environ.get(
    'MODEL_PATH', 'hf-models/internlm2_5-7b-chat')
...
class ModelList(BaseModel):
    object: str = "list"
    data: List[ModelCard] = ["internlm2_5-7b-chat"]
...
async def generate_stream(params):
    ...
    params_dict = {
        ...
        # 查看模型 tokenizer_config.json 配置停止符，否则可能推理停不下来
        "stop_token_ids": [92543, 92542, 92541, 92540, 92539],
        "ignore_eos": False,
...
async def list_models():
    model_card = ModelCard(id="internlm2_5-7b-chat")
